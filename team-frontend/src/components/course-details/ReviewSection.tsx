    ...
    <div>
      ...
      {course.ratingCount === 0 ? (
        <div className="text-center py-12 bg-gray-50 rounded-lg">
          ...
          <p className="text-gray-500 mt-2">Be the first to review this course</p>
        </div>
      ) : (
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          <div className="lg:col-span-1">
            <div className="text-center">
              <div className="text-4xl font-bold text-gray-900">{course.rating.toFixed(1)}</div>
              ...
              <div className="text-gray-600 mt-2">{course.ratingCount} ratings</div>
            </div>
          </div>
